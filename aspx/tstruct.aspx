            ...
            <div id="heightframe" runat="server">
                <div id="formContainer" class="col-xl-12">
                    <form id="form1" runat="server" enctype="multipart/form-data">
                            ...
                            <table id="tstructPS" class='table table-bordered mt-6 bordered' data-parent="tstructPsWrapper" data-title="TStruct Design Properties" data-save="false">
                                ...
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        ...
                                        <input type="range" max="30" min="14" step="2" class="form-range" id="designForntSizeSelector" oninput="document.getElementById('designForntSizeValue').textContent = this.value;" />
                                    </td>
                                </tr>
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        ...
                                        <input type="range" max="32" min="24" step="2" class="form-range" id="designControlHeightSelector" oninput="document.getElementById('designControlHeightValue').textContent = this.value;" />
                                    </td>
                                </tr>
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        ...
                                        <input type="range" max="100" min="50" step="10" class="form-range" id="designFormWidthSelector" oninput="document.getElementById('designFormWidthValue').textContent = this.value;" />
                                    </td>
                                </tr>
                                <tr data-group='general'>
                                ...
                                <tr data-group='general'>
                                    ...
                                    <td>
                                        ...
                                        <input type="range" max="50" min="10" step="10" class="form-range" id="designFieldCaptionWidthSelector" oninput="document.getElementById('designFieldCaptionWidthValue').textContent = this.value;" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <asp:HiddenField ID="hdnAxpertWebDirPath" runat="server" />
                    </form>
                </div>
