-- DROP FUNCTION fn_upsert_config_by_condition(text, text, text, text);

CREATE OR REPLACE FUNCTION fn_upsert_config_by_condition(p_tablename text, p_fieldnames text, p_fieldvalues text, p_where_clause text)
